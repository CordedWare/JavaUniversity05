...
public class HW3 {
    ...
    static public void main (String args[]){
        ...
        { // Start #7
            ...
            System.out.println("Double � ������ dd: " + test1.dd);
            System.out.println("Double � ������ dd: " + test2.dd);
            System.out.println("����� ���� ����� Double dd: " + (test2.dd + test1.dd));

            System.out.println();

            System.out.println("Float � ������ ff: " + test1.ff);
            System.out.println("Float � ������ ff: " + test2.ff);
            System.out.println("����� ���� ����� Float ff: " + (test1.ff + test2.ff + "\n"));
